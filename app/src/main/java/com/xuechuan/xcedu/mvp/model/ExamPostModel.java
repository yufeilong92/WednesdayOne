...
public class ExamPostModel implements ExamPostContract.Model {
    @Override
    public void submitExam(Context context, String score, int chapterid, int usetime, String finishtime, ArrayList<SubmiteExamVo> vo, final RequestResulteView resulteView) {
