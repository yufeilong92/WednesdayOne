...
/*
    ...
    private void initUtils() {
        ...
        mVideoUitls = VideoUitls.get_Instance(mContext);
    ...
    public ArrayList<CaseCardVo> getLists() {
        ArrayList<QuestionCaseVo> list = mQuestionSqliteHelp.queryAllQuesitonCaseWithCouresid(mCourseId);
     ...
     * @return
     */
    private ArrayList<CaseCardVo> getGalleryList() {
        ArrayList<QuestionCaseVo> list = mQuestionSqliteHelp.queryAllQuesitonCaseWithCouresid(mCourseId);
        ArrayList<CaseCardVo> mCardLists = new ArrayList<>();
        mTextUtil.doGalleryListCaseEvent(mCardLists, list);
        return mCardLists;
    }
...
/*        String d = EncryptionUtil.D(vo.getQuestion());
    ...
    public boolean getmEvalueteAble() {
        return this.mEvalueteAble;
    }

    @Override
    public ArrayList<CaseCardVo> getFuDataLists() {
        return mFuDataLists;
    }
    ...
    private void showAnswerCardLayout() {
        ...
        mPopAnswer = new CommonPopupWindow(this, R.layout.pop_case_item_answer, ViewGroup.LayoutParams.MATCH_PARENT, (int) (screenHeight * 0.7)) {
            ...
            protected void initEvent() {
                ...
                final ArrayList<DoBankSqliteVo> datas = findAllDoDatas(mMainDataLists);
            ...
            private void bindGridViewAdapter(ArrayList<DoBankSqliteVo> datas) {
                ...
                ArrayList<CaseCardVo> list = null;
    ...
    private void showResultPopLayout() {
        mPopResult = new CommonPopupWindow(this, R.layout.pop_case_result, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT) {
            ...
            protected void initEvent() {
                ...
                ArrayList<DoBankSqliteVo> vos = mDoBankHelp.finDAllUserDoText();
            ...
            private void bindData(ArrayList<DoBankSqliteVo> vos) {
                cancelTime();
...
/*    private void showSelfEvaluation() {
    ...
    private void doSubmitExam(long time) {
        ArrayList<DoBankSqliteVo> datas = findAllDoDatas(getLists());
        if (datas == null || datas.isEmpty()) return;
        //分说
        String grade = mTextUtil.getUserGrade(datas);
        ArrayList<SubmiteExamVo> doLog = mTextUtil.getUserDoLog(datas);
    ...
    //找到用户做题数据
    private ArrayList<DoBankSqliteVo> findAllDoDatas(ArrayList<CaseCardVo> mMainDataLists) {
