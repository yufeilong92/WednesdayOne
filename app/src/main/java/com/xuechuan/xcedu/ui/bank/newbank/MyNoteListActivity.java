    ...
    private void bindAdapter() {
        ...
        adapter.setOnItemClickListener(new MyNoteAdapter.OnItemClickListener() {
            ...
            public void onClickItem(Object o, int postion) {
                ...
                if (sqliteVo == null || StringUtil.isEmpty(sqliteVo.getQuestionStr())) {
                ...
                String d = EncryptionUtil.D(sqliteVo.getExplained());
                Intent intent = NoteMakeActivity.start_Intent(mContext, vo.getId(),
                        vo.getQuestionid(), Integer.parseInt(mCourseId),
                        vo.getContent(), d, buffer.toString(),2);
