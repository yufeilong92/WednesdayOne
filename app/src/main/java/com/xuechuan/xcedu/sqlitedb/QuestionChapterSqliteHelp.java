...
//            mSqLiteDatabase.endTransaction();
     ...
     * @return
     */
    public ArrayList<QuestionChapterSqliteVo> queryCalendarYearList(String courseid) {
        if (empty()) return null;
        Cursor query = mSqLiteDatabase.query(DataMessageVo.USER_QEUSTION_TABLE_QUESTION_CHAPTER, null,
                "mold=? and courseid=?",
     ...
     * @return
     */
    public ArrayList<QuestionChapterSqliteVo> queryExclusiveList(String courseid) {
        if (empty()) return null;
        Cursor query = mSqLiteDatabase.query(DataMessageVo.USER_QEUSTION_TABLE_QUESTION_CHAPTER, null,
                "mold=? and courseid=?",
