...
public class UpDeleteErrorSqlteHelp {
     ...
     * @return
     */
    public ArrayList<ErrorSqliteVo> getErrorLists(int courseid) {
        ArrayList<ErrorSqliteVo> list = new ArrayList<>();
    ...
    public ArrayList<ErrorSqliteVo> queryAllDataList(){
        if (empty())return null;
        Cursor query = mSqLiteDatabase.query(DataMessageVo.USER_INFOM_TABLE_DETUP_ERROR, null, null, null, null, null
                , null);
        ArrayList<ErrorSqliteVo> mList = new ArrayList<>();
