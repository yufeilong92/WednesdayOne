...
public class CaseAnswerAdapter extends RecyclerView.Adapter<CaseAnswerAdapter.CaseViewHolder> {
    ...
    private ArrayList<DoBankSqliteVo> mUserDoBankLists;
    ...
    public void doUserData(ArrayList<DoBankSqliteVo> data) {
     ...
     */
    public void setCaseAdapter(@NonNull CaseViewHolder holder, ArrayList<CaseCardVo> list,
                               final int paraentid) {
