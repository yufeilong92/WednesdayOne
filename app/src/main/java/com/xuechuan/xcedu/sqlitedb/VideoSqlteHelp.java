...
public class VideoSqlteHelp {
    ...
    private VideoLookSqliteVo queryIsAdd(int course, int chapterid) {
    ...
    private ContentValues getContentValues(VideoLookSqliteVo sqliteVo) {
    ...
    private VideoLookSqliteVo getVideoLookVo(DbQueryUtil mDbQueryUtil) {
