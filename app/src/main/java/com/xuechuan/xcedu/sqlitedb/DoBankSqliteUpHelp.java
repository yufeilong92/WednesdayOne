...
//        UserInfomOpenHelp userInfomOpenHelp = new UserInfomOpenHelp(context);
    ...
    public ArrayList<UpdataOrDeleteVo> queryAllDoBank() {
        if (empty()) return null;
        ...
        mDbQueryUtil.initCursor(query);
        ArrayList<UpdataOrDeleteVo> list = new ArrayList<>();
        while (query.moveToNext()) {
    ...
    private UpdataOrDeleteVo getUpDataOrDeleteVo(DbQueryUtil mDbQueryUtil) {
