...
public class SubmiteProgressQuestionService extends IntentService implements SubmiteProgressContract.View {
    ...
    public static void startActionFoo(Context context, ArrayList<UpQuestionProgressVo> mData, int courseid) {
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_FOO.equals(action)) {
                ...
                courseid = intent.getIntExtra(EXTRA_PARAM3, 0);
                handleActionFoo();
            }
        }
    }
    ...
    private void handleActionFoo() {
        ...
        presenter.submitProgress(this, courseid, mData);
    }
