...
/*    @Override
    ...
    private void initData() {
        ...
        ArrayList<ErrorSqliteVo> mErrorSqliteVoLists = mUpErrorSqlteHelp.queryAllDataList();
        ArrayList<ErrorSqliteVo> mErrorSqliteVo1Lists = mUpDeleteErrorSqlteHelp.queryAllDataList();
        ...
        ArrayList<CollectSqliteVo> mCollectSqliteVoLists = mUpCollectSqlteHelp.queryAllDataList();
        ArrayList<CollectSqliteVo> mCollectSqliteVo1Lists = mUpDeleteCollectSqlteHelp.queryAllDataList();
    ...
    public void getCollectSuccess(String success) {
        ...
        if (vo.getStatus().getCode() == 200) {
            ...
            //收藏表
            ArrayList<QuestionSqliteVo> list = mQuestionSqliteHelp.getQuestionList(datas);
    ...
    public void getErrorSuccess(String success) {
        ...
        if (vo.getStatus().getCode() == 200) {
            ...
            //
            //错题集合
            ArrayList<QuestionSqliteVo> questionList = mQuestionSqliteHelp.getQuestionList(list);
