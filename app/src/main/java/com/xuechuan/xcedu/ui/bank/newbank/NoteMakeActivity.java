...
public class NoteMakeActivity extends BaseActivity implements NoteSubmiteContract.View {
     ...
     * @return
     */
    public static Intent start_Intent(Context context, int questionid, int question, int courseid,
        ...
        intent.putExtra(PARAMT5_KEY, question);
...
*/
    ...
    protected void initContentView(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            mQuestionIdType = getIntent().getIntExtra(PARAMT5_KEY, 0);
            ...
            public void onClick(View v) {
                switch (mType) {
                    case 1://题库跳转
                        ...
                        break;
                    case 2://笔记跳转
                        Intent intent = NoteLookActivity.start_Intent(mContext, mQuestionIdType, mCouresid);
